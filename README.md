...
*O projeto tem como objetivo principal o desenvolvimento de uma loja online de discos de vinil.*

Equipe:
- [Nicole Brand](https://github.com/nicoleabrand)
- [Yasmin Mello](https://github.com/melloyasminn)
- [Gabriel Vinicius Correa](https://github.com/GabrielNebraska)

Links do projeto:
-   [Documentação](https://github.com/nicoleabrand/pi_documentacao.git)
...
**E-commerce de discos de vinil**

O projeto consiste em uma loja online especializada na venda de discos de vinil. A proposta é criar um site moderno e acessível, que permita aos clientes navegar, buscar e adquirir seus discos favoritos de forma prática e segura. Além disso, o site contará com informações detalhadas dos produtos, sistema de busca eficiente e um design voltado para os amantes de música e cultura vintage. A escolha da ideia partiu do apreço dos desenvolvedores pela cultura vintage e música.


# 2. Situação Problema

Atualmente, muitos fãs de discos de vinil enfrentam dificuldades para encontrar lojas especializadas que ofereçam uma boa experiência de compra online. A maioria dos sites existentes são limitados, desatualizados ou possuem pouca variedade de produtos, o que acaba afastando possíveis clientes. Por isso, pretendemos criar um site que abrace a modernidade sem abandonar a cultura vintage, já que, até muitos artistas modernos produzem versões de seus álbuns em discos. Nosso objetivo é criar um sistema funcional, com variedade de produtos e descrição precisa dos detalhes dos mesmos, com uma interface intuitiva e de fácil navegação e que informe o cliente sobre todas as etapas inclusas na venda, como produto, pagamento e entrega.


# 3. Descrição da proposta

O foco de ação do software será a compra e venda de discos de vinil. Ou seja, permitir que o cliente solicite pedidos e que o administrador os receba. Os níveis de usuário serão: cliente e lojista. O cliente poderá comprar discos e acessar as informações sobre produtos. O lojista poderá cadastrar novos produtos, editar produtos já cadastrados e receber os pedidos listados dos clientes. 
